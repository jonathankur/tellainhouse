    ...
    MainPage.prototype.concern = function () {
        ...
        if (usr.length)
            ...
            var alert_1 = this.alertCtrl.create({
                title: 'Please Log In',
                subTitle: 'Please Log In or Sign Up to lodge your concern',
                buttons: [
                    {
                        text: 'Ok',
                        handler: function () {
